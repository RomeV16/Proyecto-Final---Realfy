          ...
          {documents.map((doc) => (
            <EntityRow
              ...
              leading={
                ...
                >
                  <Icon name="contracts" className="h-5 w-5" strokeWidth={1.9} />
                </span>
              }
              title={
                <a
                  ...
                  className="relative z-[2] truncate transition-colors hover:text-[var(--color-brand-600)]"
                >
                  {doc.fileName}
                </a>
              }
              subtitle={`${formatFileSize(doc.fileSize)} · ${new Date(doc.createdAt).toLocaleDateString(
                'es-AR',
